      ...
      <main className="min-h-screen bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-800 text-white font-sans">
        ...
        <section className="text-center py-20 px-6">
          ...
          >
            <Link
              href="/scholarships"
              className="bg-white text-black px-8 py-3 rounded-full font-semibold shadow-lg hover:bg-gray-200 transition"
            >
              Browse Scholarships
            </Link>
          </motion.div>
        ...
        <section className="py-16 bg-white text-gray-900">
          <div className="max-w-6xl mx-auto px-4 grid sm:grid-cols-2 md:grid-cols-3 gap-10 text-center">
            ...
            <motion.div whileHover={{ scale: 1.05 }}>
              ...
              <p>Get direct links and expert tips for a successful application.</p>
            </motion.div>
            <motion.div whileHover={{ scale: 1.05 }}>
              <h3 className="text-xl font-bold mb-2">📢 Daily Updates</h3>
              <p>Stay updated with fresh international scholarship posts.</p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-20 px-6 bg-indigo-800 text-center">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {["USA", "UK", "Canada"].map((country, i) => (
              ...
              >
                <Image
                  src={`/scholarship-${country.toLowerCase()}.jpg`}
                  alt={`${country} Scholarship`}
                  width={400}
                  height={250}
        ...
        <section className="py-16 px-6 bg-gray-100 text-gray-900 text-center">
          ...
          <p className="mb-6">Subscribe to get the latest scholarships directly in your inbox.</p>
        ...
        <section className="py-16 px-6 bg-white text-gray-900 text-center">
          ...
          <p className="max-w-3xl mx-auto">
            ...
            Whether you're pursuing undergraduate, masters, or PhD, we help you succeed with trusted information 
            and direct application resources.
          </p>
        </section>
