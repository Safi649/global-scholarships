  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name="description"
          content="Discover and apply for fully funded international scholarships in 2025. Find undergraduate, master's, and PhD opportunities worldwide on Global Scholarships."
        />
        ...
        <meta
          ...
          content="Explore global scholarships for students. Undergraduate, master's, PhD scholarships — all in one place."
        />
        ...
        <meta name="twitter:title" content="Global Scholarships | Study Abroad 2025" />
        <meta
          name="twitter:description"
          content="Discover scholarships from USA, UK, Canada & more. Apply now!"
        />
      ...
      <main className="min-h-screen bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-800 text-white font-sans">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {["USA", "UK", "Canada"].map((country, i) => (
              ...
              >
                ...
                <Link href="/scholarships" className="text-blue-600 underline mt-4 inline-block">
                  Explore
                </Link>
              </motion.div>
            ))}
        ...
        <section className="py-16 px-6 bg-gray-100 text-gray-900 text-center">
          ...
          <p className="max-w-3xl mx-auto">
            Our mission is to empower students globally by providing access to verified scholarship
            opportunities. Whether you're pursuing undergraduate or PhD, we help you succeed.
          </p>
        </section>
